...
// 	return gulp.src(['app/sass/libs.+(sass|scss)'])
// 	.pipe(sass({
// 		includePaths: ['app/libs/bootstrap/dist/css'],
// 		outputStyle: 'expanded'})
// 		.on('error', sass.logError))
// 	.pipe(autoprefixer(['last 5 versions', '> 1%', 'ie 8', 'ie 7'], { cascade: true }))
// 	.pipe(gulp.dest('app/css'))
...
gulp.task('css-min', ['sass'], function() {
	return gulp.src(['!app/css/**/style.css', 'app/css/**/[^_]*.css'])
...
gulp.task('build', ['clean', 'clear-cache', 'img', 'mainfiles', 'html', 'css-min', 'scripts'], function() {
